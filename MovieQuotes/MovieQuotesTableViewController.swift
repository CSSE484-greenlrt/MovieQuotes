...
class MovieQuotesTableViewController: UITableViewController {
    ...
    let showDetailSegueIdenetifies = "ShowDetailSegue"
...
//                self.movieQuotes.insert(movieQuote, at: 0)
                ...
                // TODO: Come back here to get the app delegate
...
//                self.tableView.reloadData()
    ...
    func updateMovieQuoteArray() {
        ...
        // Execute the request in a try/cath block
...
//            movieQuotes.remove(at: indexPath.row)
    ...
    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
        ...
        if segue.identifier == showDetailSegueIdenetifies {
